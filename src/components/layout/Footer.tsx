            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 flex items-center justify-center rounded-lg bg-zinc-900 border border-zinc-800 text-zinc-500 hover:text-emerald-400 hover:border-emerald-500/30 hover:bg-emerald-500/10 transition-all"
          ...
          <div>
            ...
            <div className="mt-6 pt-6 border-t border-zinc-800">
              <div className="flex items-center gap-2 text-sm text-zinc-500 mb-2">
                ...
                <a href="mailto:hello@roicalculate.com" className="hover:text-emerald-400 transition-colors">
