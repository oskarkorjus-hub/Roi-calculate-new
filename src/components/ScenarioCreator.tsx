...
const CALCULATOR_FIELDS: Record<string, Array<{
  ...
  'mortgage': [
    ...
    { key: 'homeInsurance', label: 'Annual Insurance', type: 'currency' },
    { key: 'originationFeePercent', label: 'Origination Fee', type: 'percent', suffix: '%' },
    { key: 'hoaFees', label: 'HOA Fees (Monthly)', type: 'currency' },
  ],
  'rental-roi': [
    ...
    { key: 'keys', label: 'Number of Keys', type: 'number', description: 'Rooms/units' },
  ],
  'cashflow': [
    ...
    { key: 'monthlyUtilities', label: 'Monthly Utilities', type: 'currency' },
    { key: 'vacancyRate', label: 'Vacancy Rate', type: 'percent', suffix: '%' },
    { key: 'projectionPeriod', label: 'Projection Period', type: 'years', suffix: ' years' },
    { key: 'annualGrowthRate', label: 'Annual Growth', type: 'percent', suffix: '%' },
  ],
  'dev-feasibility': [
    ...
    { key: 'projectDuration', label: 'Project Duration', type: 'months', suffix: ' months' },
  ],
  'cap-rate': [
    ...
    { key: 'annualMaintenance', label: 'Annual Maintenance', type: 'currency' },
  ],
  'xirr': [
    ...
    { key: 'exit.closingCostsPercent', label: 'Closing Costs', type: 'percent', suffix: '%' },
  ...
  'rental-projection': [
    ...
    { key: 'seasonalPeakMultiplier', label: 'Peak Season Multiplier', type: 'number' },
    { key: 'seasonalLowMultiplier', label: 'Low Season Multiplier', type: 'number' },
  ],
  'financing': [
    { key: 'propertyValue', label: 'Property Value', type: 'currency', description: 'Total property purchase price' },
    { key: 'downPaymentPercent', label: 'Down Payment', type: 'percent', suffix: '%' },
    { key: 'loans.0.interestRate', label: 'Loan 1 Interest Rate', type: 'percent', suffix: '%' },
    { key: 'loans.0.term', label: 'Loan 1 Term', type: 'years', suffix: ' years' },
    { key: 'loans.0.originationFeePercent', label: 'Loan 1 Origination Fee', type: 'percent', suffix: '%' },
    { key: 'loans.1.interestRate', label: 'Loan 2 Interest Rate', type: 'percent', suffix: '%' },
    { key: 'loans.1.term', label: 'Loan 2 Term', type: 'years', suffix: ' years' },
  ],
  'indonesia-tax': [
    { key: 'purchasePrice', label: 'Purchase Price', type: 'currency' },
    { key: 'projectedSalePrice', label: 'Sale Price', type: 'currency' },
    { key: 'holdingPeriod', label: 'Holding Period', type: 'years', suffix: ' years' },
    { key: 'buildingValue', label: 'Building Value', type: 'currency', description: 'Portion allocated to building (for depreciation)' },
    { key: 'buildingDepreciationRate', label: 'Depreciation Rate', type: 'percent', suffix: '%' },
    { key: 'corporateTaxRate', label: 'Corporate Tax Rate', type: 'percent', suffix: '%' },
    { key: 'individualCapGainRate', label: 'Individual Cap Gains Rate', type: 'percent', suffix: '%' },
    { key: 'acquisitionCosts', label: 'Acquisition Costs', type: 'currency' },
    { key: 'sellingCosts', label: 'Selling Costs', type: 'currency' },
  ],
  'dev-budget': [
    { key: 'landCost', label: 'Land Cost (Budget)', type: 'currency', description: 'Budgeted land acquisition cost' },
    { key: 'landCostActual', label: 'Land Cost (Actual)', type: 'currency', description: 'Actual land cost spent' },
    { key: 'constructionHard', label: 'Construction (Budget)', type: 'currency', description: 'Budgeted hard costs' },
    { key: 'constructionHardActual', label: 'Construction (Actual)', type: 'currency', description: 'Actual construction spent' },
    { key: 'softCosts', label: 'Soft Costs (Budget)', type: 'currency', description: 'Permits, design, fees' },
    { key: 'softCostsActual', label: 'Soft Costs (Actual)', type: 'currency', description: 'Actual soft costs spent' },
    { key: 'contingency', label: 'Contingency (Budget)', type: 'currency' },
    { key: 'contingencyUsed', label: 'Contingency Used', type: 'currency', description: 'Contingency amount spent' },
    { key: 'financing', label: 'Financing (Budget)', type: 'currency' },
    { key: 'financingActual', label: 'Financing (Actual)', type: 'currency' },
    { key: 'marketing', label: 'Marketing (Budget)', type: 'currency' },
    { key: 'marketingActual', label: 'Marketing (Actual)', type: 'currency' },
    { key: 'totalProjectDuration', label: 'Project Duration', type: 'months', suffix: ' months' },
    { key: 'completionPct', label: 'Completion %', type: 'percent', suffix: '%' },
  ],
  'risk-assessment': [
    { key: 'investmentAmount', label: 'Investment Amount', type: 'currency' },
    { key: 'projectROI', label: 'Expected ROI', type: 'percent', suffix: '%' },
    { key: 'annualCashFlow', label: 'Annual Cash Flow', type: 'currency' },
    { key: 'breakEvenMonths', label: 'Break-even', type: 'months', suffix: ' months' },
    { key: 'averageOccupancy', label: 'Average Occupancy', type: 'percent', suffix: '%' },
    { key: 'debtServiceCoverageRatio', label: 'DSCR', type: 'number', suffix: 'x', description: 'Debt Service Coverage Ratio' },
    { key: 'leverageRatio', label: 'Leverage Ratio', type: 'number', description: 'Debt / Total Investment' },
    { key: 'equityAmount', label: 'Equity Amount', type: 'currency' },
    { key: 'debtAmount', label: 'Debt Amount', type: 'currency' },
  ],
};
