    ...
    <div className="space-y-3">
      ...
      <div className="relative">
        ...
        <input
          ...
          placeholder="0"
          className={`w-full bg-zinc-800 border border-zinc-700 rounded-lg py-2.5 text-sm font-medium text-white placeholder:text-zinc-500 outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-all tabular-nums ${prefix ? 'pl-10 pr-4' : suffix ? 'pl-4 pr-10' : 'px-4'}`}
        />
        {suffix && (
