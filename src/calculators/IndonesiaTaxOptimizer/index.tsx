              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <select
                    ...
                    className="w-full bg-zinc-800 border border-zinc-700 rounded-lg py-2.5 px-4 text-sm font-medium text-white focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-all"
                  >
    ...
    <div className="space-y-3">
      ...
      <div className="relative">
        ...
        <input
          ...
          placeholder="0"
          className={`w-full bg-zinc-800 border border-zinc-700 rounded-lg py-2.5 text-sm font-medium text-white placeholder:text-zinc-500 outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-all tabular-nums ${prefix ? 'pl-10 pr-4' : suffix ? 'pl-4 pr-12' : 'px-4'}`}
        />
        {suffix && (
